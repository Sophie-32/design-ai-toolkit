...
| Type | Project                                                                           | Author           | Good for       | Data              | Description                              |
|------|-----------------------------------------------------------------------------------|------------------|----------------|-------------------|------------------------------------------|
...
| ⚙️   | [Figma design system setup](projects/figma-design-system-setup)                   |                  | Design systems | ☁️ Figma          | Sets up Figma to use the design system   |
| ⚙️   | [VS Code design system setup](projects/vscode-design-system-setup)                |                  | Design systems | 💻 Local          | Sets up VS Code to design with the DS    |
| 📦   | [JIRA triggers](projects/jira-triggers)                                           | Hartmut Obendorf | Automation     | ☁️ JIRA API       | Automation triggers for design workflows |

🔮 Gem · 🛠 Skill · 💻 Code · ⚙️ Setup · 📦 Other
